cmd_tools/image-host.o := cc -Wp,-MD,tools/.image-host.o.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer   -include /buildpd/10BDL4551T_SZ/u-boot/include/libfdt_env.h -idirafterinclude -idirafter/buildpd/10BDL4551T_SZ/u-boot/arch/arm/include -I/buildpd/10BDL4551T_SZ/u-boot/lib/libfdt -I/buildpd/10BDL4551T_SZ/u-boot/tools -DCONFIG_SYS_TEXT_BASE=0x00000000 -DUSE_HOSTCC -D__KERNEL_STRICT_NAMES -D_GNU_SOURCE  -c -o tools/image-host.o tools/image-host.c
