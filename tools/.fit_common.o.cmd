cmd_tools/fit_common.o := cc -Wp,-MD,tools/.fit_common.o.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer   -include /buildpd/10BDL4551T_SZ/u-boot/include/libfdt_env.h -idirafterinclude -idirafter/buildpd/10BDL4551T_SZ/u-boot/arch/arm/include -I/buildpd/10BDL4551T_SZ/u-boot/lib/libfdt -I/buildpd/10BDL4551T_SZ/u-boot/tools -DCONFIG_SYS_TEXT_BASE=0x00000000 -DUSE_HOSTCC -D__KERNEL_STRICT_NAMES -D_GNU_SOURCE  -c -o tools/fit_common.o tools/fit_common.c
