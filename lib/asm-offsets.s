...
@ -I /buildpd/10BDL4551T_SZ/u-boot/arch/arm/include
@ -iprefix /buildpd/10BDL4551T_SZ/prebuilts/gcc/linux-x86/arm/arm-eabi-4.8/bin/../lib/gcc/arm-eabi/4.8/
@ -D__USES_INITFINI__ -D __KERNEL__ -D __UBOOT__
@ -D CONFIG_SYS_TEXT_BASE=0x00000000 -D __ARM__ -D DO_DEPS_ONLY
@ -D KBUILD_STR(s)=#s -D KBUILD_BASENAME=KBUILD_STR(asm_offsets)
@ -D KBUILD_MODNAME=KBUILD_STR(asm_offsets)
@ -isystem /buildpd/10BDL4551T_SZ/prebuilts/gcc/linux-x86/arm/arm-eabi-4.8/bin/../lib/gcc/arm-eabi/4.8/include
@ -include /buildpd/10BDL4551T_SZ/u-boot/include/linux/kconfig.h
...
@ 0 "" 2
	.loc 1 46 0
@ 46 "lib/asm-offsets.c" 1
	
.ascii "->PM_CTX_PHYS #240 offsetof(struct global_data, pm_ctx_phys)"	@
@ 0 "" 2
	.loc 1 49 0
	mov	r0, #0	@,
	bx	lr	@
...
.LFE160:
	...
	.text
.Letext0:
	.file 2 "/buildpd/10BDL4551T_SZ/u-boot/arch/arm/include/asm/types.h"
...
.LASF56:
	...
	.ascii	"nux -mword-relocations -march=armv7-a -mno-unaligne"
	.ascii	"d-access -mfloat-abi=soft -mfpu=vfp -g -Os -fno-bui"
	.ascii	"ltin -ffreestanding -fno-stack-protector -fstack-us"
	.ascii	"age -ffunction-sections -fdata-sections -fno-common"
	.ascii	" -ffixed-r9\000"
.LASF23:
...
.LASF58:
	.ascii	"/buildpd/10BDL4551T_SZ/u-boot\000"
.LASF43:
	.ascii	"send\000"
.LASF36:
	.ascii	"bd_info\000"
